...
// ─────────────────────────────────────────────────────────────────
// Senaryo 08 — "Q4 Hedefi"
// Fabrika dashboard, üretim tahmini.
// Mood: Industrial pulse, mechanical rhythm.
// ─────────────────────────────────────────────────────────────────
...
export default function Senaryo8Page() {
  return (
    <SenaryoStage
      sceneTimings={SCENE_TIMINGS}
      topLabel="argus teknoloji · senaryo 08 · q4 hedefi"
      timeline={["fabrika", "soru", "altaris", "darboğaz", "süre", "müdahale"]}
    >
      <section className="scene s1">
        <div className="stage">
          <div className="max-w-3xl">
            <div className="text-[11px] uppercase tracking-[0.32em] text-[#7a7166]">/ üretim panosu · ekim ortası</div>
            <h1 className="mt-3 text-[clamp(36px,5vw,72px)] font-light leading-[1.05] tracking-tight text-[#ddd8d0]">
              Q4 hedefleri.<br />
              <span className="text-[#7a7166]">Aralık'a 8 hafta.</span>
            </h1>
            <div className="mt-12 grid grid-cols-3 gap-4 max-w-2xl">
              {[["12.4M", "ünite hedef"], ["%87", "kapasite"], ["3", "tedarikçi"]].map(([v, l]) => (
        ...
        <div className="stage">
          <div className="max-w-4xl text-center">
            <h2 className="text-[clamp(36px,5.5vw,80px)] font-light leading-[1.1] tracking-tight text-[#ddd8d0]">
              ...
              Q4 hedefleri<br />
              <span className="grad-text font-medium">tutar mı</span>?
              <span className="text-[#5a534a]">"</span>
            </h2>
            <p className="mt-10 text-base text-[#7a7166]">ERP, tedarik, kapasite, sipariş, lojistik — <span className="text-[#ddd8d0]">tek bakışta görmek imkansız</span>.</p>
          </div>
        </div>
      </section>
      ...
      <section className="scene s3">
        <div className="stage">
          <div className="w-full max-w-3xl">
            <div className="mb-5 text-[10px] uppercase tracking-[0.32em] text-[#6b6358]">altaris · çapraz tahmin</div>
            <div className="rounded-md border border-[rgba(120,80,50,0.32)] bg-[#0d0b0a] p-6">
              <p className="text-base text-[#ddd8d0]">
                <span className="text-[#f08c50]">▸</span> 47 değişken · 18 ay tarihçe · 5 senaryo simülasyonu
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="stage">
          <div className="w-full max-w-5xl">
            <div className="mb-6 flex items-baseline justify-between">
              <div className="text-[11px] uppercase tracking-[0.32em] text-[#9bd07e]">/ tahmin</div>
              <div className="text-[10px] uppercase tracking-[0.22em] text-[#7a7166]">3 sebep · sıralı</div>
            </div>
            <div className="text-center mb-6">
              <div className="text-[10px] uppercase tracking-[0.28em] text-[#7a7166]">hedef tutma olasılığı</div>
            ...
            <div className="grid gap-3 md:grid-cols-3">
              {[
                ["Tedarikçi P · darboğaz", "Hammadde 4 hafta gecikecek · alternatif: yerli", "%32"],
                ["Hat 2 · kapasite", "Bakım planı Q4 ortasında · taşımak gerek", "%21"],
                ["Lojistik · liman", "İhracat trafiği yoğun · erken booking", "%18"],
              ].map(([t, d, p]) => (
      ...
      <section className="scene s5">
        <div className="stage">
          <div className="text-center">
            <div className="text-[11px] uppercase tracking-[0.32em] text-[#7a7166]">/ klasik tahmin · ekip toplantıları</div>
            <div className="mt-6 flex items-center justify-center gap-8">
              <div className="text-[clamp(56px,8vw,128px)] font-light leading-none text-[#7a7166] line-through decoration-[#7a7166]/40">2 hafta</div>
              <div className="text-[#f08c50]">→</div>
              <div className="text-[clamp(72px,11vw,160px)] font-light leading-none">
                <span className="grad-text font-medium">90 sn</span>
              </div>
            </div>
            <p className="mt-8 text-base text-[#bdb4a6]">Şimdi müdahale — <span className="text-[#ddd8d0]">aralıkta hedef tutar</span>.</p>
          </div>
        </div>
      </section>
...
▀ ▀   ▀▀▀   ▀    ▀ ▀   ▀ ▀   ▀   ▀▀▀`}
            ...
            <div className="mt-4 text-[11px] uppercase tracking-[0.32em] text-[#f08c50]">superagent — üretimi anlık tahmin</div>
            <div className="mx-auto mt-12 inline-flex items-center gap-4 rounded-md border border-[#f08c50] bg-[#f08c50] px-7 py-4 text-[#0a0908]">
              <span className="text-[10px] uppercase tracking-[0.32em]">/ üretim tahmini</span>
      ...
      <SenaryoPlayer schedule={schedule} durationSec={TOTAL} filenamePrefix="senaryo-08-q4" label="senaryo 08 · q4 hedefi" />
    </SenaryoStage>
  );
}
