...
// ──────────────────────────────────────────────────────────────────────────
// Altaris — 22-second scenario demo · ENGLISH VERSION
//
// Not a flat catalog scroll — a mini story taken from a real Monday morning
// at the executive's desk. Self-playing CSS keyframe chain. Whoever opens
// the page sees the 22s narrative and goes "ah, that's what this is for."
//
// Scene plan (CSS animation-delay chain):
//   0–3s   Monday 08:30 — executive's desk, scattered data
//   3–6s   The question — "What 3 risks are on my plate this week?"
//   6–9s   Altaris UI — typing + thinking pulse
//   9–15s  Answer — 3 risk cards + data sources
//   15–18s Numerical punch — "4 hours → 12 seconds"
//   18–22s ALTARIS + CTA
// ──────────────────────────────────────────────────────────────────────────
...
const TYPED_QUESTION = "What 3 risks are on my plate this week?";

export default function SenaryoEnPage() {
  return (
    <>
      <style>{`
      ...
      <main className="relative h-screen w-screen overflow-hidden bg-[#0a0908] font-mono text-[#ddd8d0] antialiased">
        ...
        <div className="ui-chrome absolute left-0 right-0 top-0 z-10 flex items-center justify-between px-8 py-4 text-[10px] uppercase tracking-[0.32em] text-[#6b6358] transition-opacity duration-300">
          <span>argus teknoloji · scenario</span>
          <span>22 sec</span>
        </div>
        ...
        <div className="ui-chrome absolute bottom-6 left-1/2 z-10 -translate-x-1/2 transition-opacity duration-300">
          <div className="flex items-center gap-3 text-[9px] uppercase tracking-[0.32em] text-[#3a342d]">
            {["monday", "question", "altaris", "answer", "time", "pilot"].map((s, i) => (
        ...
        {/* SCENE 1: Monday 08:30 */}
        <section className="scene s1">
          <div className="stage">
            <div className="relative w-full max-w-5xl">
              <div className="text-[11px] uppercase tracking-[0.32em] text-[#7a7166]">/ monday · 08:30</div>
              <h1 className="mt-3 text-[clamp(36px,5vw,72px)] font-light leading-[1.05] tracking-tight text-[#ddd8d0]">
                Executive's desk.<br />
                <span className="text-[#7a7166]">Information everywhere.</span>
              </h1>

              <div className="pointer-events-none mt-12 grid grid-cols-2 gap-6 md:grid-cols-4">
                {[
                  ["47 new emails",          "outlook"],
                  ["12 dashboards updated",  "BI"],
                  ["3 meetings pending",     "calendar"],
                  ["8 contracts to sign",    "documents"],
                ].map(([t, src], i) => (
              ...
              <p className="mt-12 max-w-xl text-sm leading-relaxed text-[#9b9285]">
                Scattered across 12 different systems. Pulling it all together to make a decision —{" "}
                <span className="text-[#ddd8d0]">hours of analysis</span>.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="scene s2">
          <div className="stage">
            <div className="max-w-4xl text-center">
              <div className="text-[11px] uppercase tracking-[0.32em] text-[#7a7166]">/ the executive's question</div>
              <h2 className="mt-6 text-[clamp(36px,5.5vw,80px)] font-light leading-[1.1] tracking-tight text-[#ddd8d0]">
                ...
                What{" "}
                <span className="grad-text font-medium">3 risks</span>{" "}
                are on my plate this week?
                <span className="text-[#5a534a]">"</span>
              </h2>
              <p className="mt-10 text-base text-[#7a7166]">
                The answer: <span className="text-[#ddd8d0]">scattered across 12 systems.</span>
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="stage">
            <div className="w-full max-w-3xl">
              ...
              <div className="rounded-md border border-[rgba(120,80,50,0.32)] bg-[#0d0b0a] p-6 shadow-[0_0_0_1px_rgba(0,0,0,0.4),0_30px_60px_-30px_rgba(240,140,80,0.25)]">
                <div className="mb-3 text-[10px] uppercase tracking-[0.28em] text-[#7a7166]">/ ask the executive</div>
                ...
                <div className="mt-6 flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-sm text-[#ddd8d0]">SuperAgent thinking…</div>
                    <div className="mt-1 text-[11px] uppercase tracking-[0.22em] text-[#7a7166]">
                      crm · erp · email · contracts · projects · finance
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* SCENE 4: Answer — 3 risk cards */}
        <section className="scene s4">
          <div className="stage">
            <div className="w-full max-w-5xl">
              <div className="mb-6 flex items-baseline justify-between">
                <div className="text-[11px] uppercase tracking-[0.32em] text-[#9bd07e]">/ answer · live</div>
                <div className="text-[10px] uppercase tracking-[0.22em] text-[#7a7166]">3 results</div>
              </div>

              <div className="grid gap-5 md:grid-cols-3">
                {[
                  {
                    title: "Supplier X delay",
                    metric: "23% ↑",
                    detail: "Last 6 months avg delivery 4.2 days late. Q4 stockout risk critical.",
                    sources: ["ERP", "Supply", "Email"],
                  },
                  {
                    title: "Customer Y payment",
                    metric: "47 days",
                    detail: "Past due; ₺1.4M outstanding. 3 separate project payments affected.",
                    sources: ["CRM", "Accounting", "Contracts"],
                  },
                  {
                    title: "Project Z budget",
                    metric: "18% over",
                    detail: "Cost overrun for end-of-November delivery; team capacity also booked.",
                    sources: ["Projects", "Finance", "HR"],
                  },
                ].map((r, i) => (
                  <div
                    key={r.title}
        ...
        <section className="scene s5">
          <div className="stage">
            <div className="text-center">
              <div className="text-[11px] uppercase tracking-[0.32em] text-[#7a7166]">/ human · 4-hour analysis</div>
              ...
              <p className="mt-8 text-base text-[#bdb4a6]">
                ...
                Same question, same answer, same sources.
              </p>
            </div>
          </div>
        </section>
...
{ALTARIS_ASCII}
              ...
              <div className="mt-4 text-[11px] uppercase tracking-[0.32em] text-[#f08c50]">
                superagent — your company's second brain
              </div>
              ...
              <div className="cta-glow mx-auto mt-12 inline-flex items-center gap-4 rounded-md border border-[#f08c50] bg-[#f08c50] px-7 py-4 text-[#0a0908]">
                ...
                <span className="font-medium">30 days free · with your own data</span>
              </div>
