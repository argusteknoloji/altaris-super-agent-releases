...
const TR: CliDict = {
  ...
  commands: {
    ...
    rows: [
      ...
      ["altaris shell-install --with-vscode", "altaris'i PATH'e kur + VS Code extension'ı (VSIX) tek komutla yükle."],
  ...
  install: {
    ...
    vscode: {
      ...
      version: "v0.1.0",
      installCmd: "altaris shell-install --with-vscode",
...
const EN: CliDict = {
  ...
  commands: {
    ...
    rows: [
      ...
      ["altaris shell-install --with-vscode", "Install altaris on PATH + the VS Code extension (VSIX) in one command."],
...
const DE: CliDict = {
  ...
  commands: {
    ...
    rows: [
      ...
      ["altaris shell-install --with-vscode", "altaris in den PATH legen + VS-Code-Extension (VSIX) in einem Befehl installieren."],
