...
const TR: CliDict = {
  ...
  scenes: [
    {
      ...
      lines: [
        ...
        { k: "out",  t: "  provider  ollama (qwen2.5-coder:7b) · local" },
      ],
    },
    {
      num: "II", slug: "vault",
  ...
  commands: {
    ...
    rows: [
      ...
      ["altaris vaults sync",          "Obsidian vault'unu indeksle ve agentic shell'e bağla."],
  ...
  providers: {
    ...
    col: { name: "provider", mode: "mod", example: "endpoint / model" },
    rows: [
      { name: "Ollama",     mode: "lokal",       example: "http://localhost:11434 · qwen2.5-coder:7b", tag: "varsayılan" },
      { name: "LM Studio",  mode: "lokal",       example: "https://llm.argusteknoloji.com/v1" },
      { name: "Anthropic",  mode: "bulut",       example: "claude-sonnet-4-7 · claude-opus-4-7" },
      { name: "OpenAI",     mode: "bulut",       example: "gpt-5 · o3" },
      { name: "Codex",      mode: "abonelik",    example: "codexplan · seat-paylaşımlı" },
    ],
    note: "Bulut sağlayıcıları her tenant için ayrı API key + ayrı kota — kullanıcı seviyesinde değil.",
  },
  install: {
    head: "kurulum",
...
const EN: CliDict = {
  ...
  commands: {
    ...
    rows: [
      ...
      ["altaris vaults sync",          "Index your Obsidian vault and bind it to the agentic shell."],
  ...
  providers: {
    ...
    col: { name: "provider", mode: "mode", example: "endpoint / model" },
    rows: [
      { name: "Ollama",     mode: "local",        example: "http://localhost:11434 · qwen2.5-coder:7b", tag: "default" },
      { name: "LM Studio",  mode: "local",        example: "https://llm.argusteknoloji.com/v1" },
      { name: "Anthropic",  mode: "cloud",        example: "claude-sonnet-4-7 · claude-opus-4-7" },
      { name: "OpenAI",     mode: "cloud",        example: "gpt-5 · o3" },
      { name: "Codex",      mode: "subscription", example: "codexplan · seat-shared" },
    ],
    note: "Cloud providers carry tenant-level API keys + tenant-level quota — never user-level.",
  },
  install: {
    head: "install",
...
const DE: CliDict = {
  ...
  scenes: [
    {
      ...
      lines: [
        ...
        { k: "out",  t: "  tenant    argus · MMVI Teams" },
        { k: "out",  t: "  role      platform_admin" },
        { k: "out",  t: "  provider  ollama (qwen2.5-coder:7b) · lokal" },
      ],
    },
    {
      num: "II", slug: "vault",
  ...
  commands: {
    ...
    rows: [
      ...
      ["altaris vaults sync",          "Obsidian-Vault indexieren und an die agentic shell binden."],
  ...
  providers: {
    ...
    col: { name: "provider", mode: "modus", example: "endpoint / modell" },
    rows: [
      { name: "Ollama",     mode: "lokal",       example: "http://localhost:11434 · qwen2.5-coder:7b", tag: "Standard" },
      { name: "LM Studio",  mode: "lokal",       example: "https://llm.argusteknoloji.com/v1" },
      { name: "Anthropic",  mode: "cloud",       example: "claude-sonnet-4-7 · claude-opus-4-7" },
      { name: "OpenAI",     mode: "cloud",       example: "gpt-5 · o3" },
      { name: "Codex",      mode: "abonnement",  example: "codexplan · seat-geteilt" },
    ],
    note: "Cloud-Provider laufen auf Tenant-API-Keys mit Tenant-Quota — niemals auf Benutzerebene.",
  },
  install: {
    head: "installation",
