...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/altaris.proto')
...
const altarisProto = protoDescriptor.altaris.v1
...
async function main() {
  ...
  const client = new altarisProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mAltaris gRPC CLI\x1b[0m')
