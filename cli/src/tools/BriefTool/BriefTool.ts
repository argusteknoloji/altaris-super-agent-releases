 ...
 *
 * ALTARIS_BRIEF env var force-grants entitlement for dev/testing —
...
export function isBriefEntitled(): boolean {
  ...
  return feature('KAIROS') || feature('KAIROS_BRIEF')
    ? getKairosActive() ||
        isEnvTruthy(process.env.ALTARIS_BRIEF) ||
 ...
 *   - ALTARIS_BRIEF env var (maybeActivateBrief — dev/testing bypass)
