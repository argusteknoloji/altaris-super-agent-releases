...
export const DESCRIPTION = 'Get or set Altaris configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Altaris configuration settings.

  View or change Altaris settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.altaris.json)
${globalSettings.join('\n')}
