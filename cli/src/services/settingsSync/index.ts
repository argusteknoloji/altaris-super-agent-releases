 ...
 *
 * Syncs user settings and memory files across Altaris environments.
 *
...
function getSettingsSyncEndpoint(): string {
  return `${getOauthConfig().BASE_API_URL}/api/altaris/user_settings`
}
 ...
 * - clearMemoryFileCaches() for memory files (ALTARIS.md)
 */
