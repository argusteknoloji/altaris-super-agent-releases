...
/**
 * Full response from GET /api/altaris/user_settings
 */
...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.altaris/settings.json',
  USER_MEMORY: '~/.altaris/ALTARIS.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.altaris/settings.local.json`,
