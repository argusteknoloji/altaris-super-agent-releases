...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Altaris now.</p>
    <p>Altaris will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Altaris.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Altaris.</p>
  </body>
</html>`
}
