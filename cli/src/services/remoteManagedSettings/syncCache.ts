 ...
 *   ALTARIS_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Check OAuth first: most anthropic.com users have no API key in the keychain.
  ...
  // Externally-injected tokens (CCD via ALTARIS_OAUTH_TOKEN, CCR via
  // ALTARIS_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
