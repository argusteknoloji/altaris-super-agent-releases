...
Based on the user conversation above (EXCLUDING this note-taking instruction message as well as system prompt, altaris.md entries, or any past session summaries), update the session notes file.
...
- Do not include information that's already in the ALTARIS.md files included in the context
 ...
 * Custom prompts can be placed at ~/.altaris/session-memory/prompt.md
