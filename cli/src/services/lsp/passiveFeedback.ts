...
/**
 * Map LSP severity to Altaris diagnostic severity
 *
 * Maps LSP severity numbers to Altaris diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to Altaris diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by Altaris's attachment system.
 */
 ...
 * from all LSP servers and routes them to Altaris's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to Altaris format (can throw on invalid URIs)
