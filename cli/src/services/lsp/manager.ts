 ...
 * Initialized during Altaris startup.
 */
 ...
 * asynchronously during Altaris startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Altaris startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/altaris/issues/15521:
 ...
 *
 * This should be called during Altaris shutdown. Stops all running LSP servers
