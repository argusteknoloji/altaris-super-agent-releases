...
export function getProjectMcpServerStatus(
  ...
  // flagSettings/policySettings but NOT projectSettings (repo-level .altaris/settings.json).
  ...
  // In non-interactive mode (SDK, altaris -p, piped input), there's no way to
...
export function getMcpServerScopeFromToolName(
  ...
  // Fallback: altaris.ai servers have normalized names starting with "claude_ai_"
