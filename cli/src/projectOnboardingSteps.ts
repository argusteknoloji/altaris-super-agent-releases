...
export function getSteps(): Step[] {
  ...
  return [
    {
      key: 'workspace',
      text: 'Ask Altaris to create a new app or clone a repository',
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: 'altarismd',
      text: 'Set up repo instructions (/init creates AGENTS.md or updates existing ALTARIS.md; either file counts)',
