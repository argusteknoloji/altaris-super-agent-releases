...
// fails when altaris runs remotely inside a VS Code integrated terminal.
...
export function supportsExtendedKeys(): boolean {
  // Open Altaris defaults this off because some real terminals render the UI
  ...
  if (process.env.ALTARIS_ENABLE_EXTENDED_KEYS !== '1') {
    return false
  }
