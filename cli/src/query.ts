...
export type QueryParams = {
  ...
  // from cumulative API usage. See configureTaskBudgetParams in altaris.ts.
...
> {
  ...
  while (true) {
    ...
    // @see https://docs.altaris.com/en/docs/build-with-altaris/tool-use
    ...
    // These will be sent as attachments so Altaris can respond to them in the current turn.
    //
    ...
    // Periodic task summary for `altaris ps` — fires mid-turn so a
