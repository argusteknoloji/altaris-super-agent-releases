...
const FALLBACK_MESSAGE = 'Review and manage your privacy settings at https://altaris.ai/settings/data-privacy-controls';
export async function call(onDone: LocalJSXCommandOnDone): Promise<React.ReactNode | null> {
  ...
  async function onDoneWithSettingsCheck() {
    ...
    onDone(`"Help improve Altaris" set to ${groveStatus}.`);
