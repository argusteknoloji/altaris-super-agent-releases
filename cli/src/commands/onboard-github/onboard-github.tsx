...
export function buildGithubOnboardingSettingsEnv(
  ...
  return {
    ...
    ALTARIS_USE_OPENAI: undefined,
    ALTARIS_USE_GEMINI: undefined,
    ALTARIS_USE_BEDROCK: undefined,
    ALTARIS_USE_VERTEX: undefined,
    ALTARIS_USE_FOUNDRY: undefined,
  }
}
...
export function applyGithubOnboardingProcessEnv(
  ...
  delete env.ALTARIS_PROVIDER_PROFILE_ENV_APPLIED
  delete env.ALTARIS_PROVIDER_PROFILE_ENV_APPLIED_ID
}
  ...
  return (
    <Box flexDirection="column" gap={1}>
      ...
      <Text dimColor>
        ...
        and enables ALTARIS_USE_GITHUB in your user settings - no export
    ...
    if (!activated.ok) {
      onDone(
        `GitHub token detected, but settings activation failed: ${activated.detail ?? 'unknown error'}. ` +
          'Set ALTARIS_USE_GITHUB=1 and OPENAI_MODEL=github:copilot in user settings manually.',
        { display: 'system' },
      )
      return null
    }
