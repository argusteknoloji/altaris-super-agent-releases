...
export function ExistingWorkflowStep(t0) {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box flexDirection="column" marginBottom={1}><Text>A Altaris workflow file already exists at{" "}<Text color="altaris">.github/workflows/altaris.yml</Text></Text><Text dimColor={true}>What would you like to do?</Text></Box>;
    $[8] = t6;
  } else {
    t6 = $[8];
  }
  ...
  if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Box marginTop={1}><Text dimColor={true}>View the latest workflow template at:{" "}<Text color="altaris">https://github.com/anthropics/altaris-action/blob/main/examples/altaris.yml</Text></Text></Box>;
    $[12] = t8;
  } else {
    t8 = $[12];
  }
