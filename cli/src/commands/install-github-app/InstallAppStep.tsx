...
export function InstallAppStep(t0) {
  ...
  if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Box flexDirection="column" marginBottom={1}><Text bold={true}>Install the Altaris GitHub App</Text></Box>;
    $[1] = t2;
  } else {
    t2 = $[1];
  }
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box marginBottom={1}><Text>Opening browser to install the Altaris GitHub App…</Text></Box>;
    $[2] = t3;
  } else {
    t3 = $[2];
  }
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Box marginBottom={1}><Text underline={true}>https://github.com/apps/altaris</Text></Box>;
    $[4] = t5;
  } else {
    t5 = $[4];
  }
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Box marginTop={1}><Text dimColor={true}>Having trouble? See manual setup instructions at:{" "}<Text color="altaris">{GITHUB_ACTION_SETUP_DOCS_URL}</Text></Text></Box>;
    $[9] = t9;
  } else {
    t9 = $[9];
  }
