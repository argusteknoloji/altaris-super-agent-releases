...
// user triggers, so the description carries "Altaris on the web" + URL.
const CCR_TERMS_URL = 'https://code.claude.com/docs/en/altaris-on-the-web'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Altaris on the web. See ${CCR_TERMS_URL}`,
