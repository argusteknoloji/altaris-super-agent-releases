...
function setEffortValue(effortValue: EffortValue): EffortCommandResult {
  ...
  if (envOverride !== undefined && envOverride !== effortValue) {
    const envRaw = process.env.ALTARIS_EFFORT_LEVEL;
    if (persistable === undefined) {
      return {
        message: `Not applied: ALTARIS_EFFORT_LEVEL=${envRaw} overrides effort this session, and ${effortValue} is session-only (nothing saved)`,
        effortUpdate: {
          value: effortValue
        }
      };
    ...
    return {
      message: `ALTARIS_EFFORT_LEVEL=${envRaw} overrides this session — clear it and ${effortValue} takes over`,
      effortUpdate: {
        value: effortValue
      }
    };
...
function unsetEffortLevel(): EffortCommandResult {
  ...
  if (envOverride !== undefined && envOverride !== null) {
    const envRaw = process.env.ALTARIS_EFFORT_LEVEL;
    return {
      message: `Cleared effort from settings, but ALTARIS_EFFORT_LEVEL=${envRaw} still controls this session`,
      effortUpdate: {
        value: undefined
      }
    };
