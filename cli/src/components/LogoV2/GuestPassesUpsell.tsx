...
export function GuestPassesUpsell() {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t0 = <Text dimColor={true}><Text color="claude">[✻]</Text> <Text color="claude">[✻]</Text>{" "}<Text color="claude">[✻]</Text> ·{" "}{reward ? `Share Altaris and earn ${formatCreditAmount(reward)} of extra usage · /passes` : "3 guest passes at /passes"}</Text>;
    $[0] = t0;
  } else {
    t0 = $[0];
  }
