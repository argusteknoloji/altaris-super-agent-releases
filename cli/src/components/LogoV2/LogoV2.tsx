...
export function LogoV2() {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = !hasReleaseNotes && !showOnboarding && !isEnvTruthy(process.env.ALTARIS_FORCE_FULL_LOGO);
    $[5] = t4;
  } else {
    t4 = $[5];
  }
  ...
  if (!hasReleaseNotes && !showOnboarding && !isEnvTruthy(process.env.ALTARIS_FORCE_FULL_LOGO)) {
    let t11;
    let t12;
    let t13;
    let t14;
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      t16 = <EmergencyTip />;
      t17 = process.env.ALTARIS_TMUX_SESSION && <Box paddingLeft={2} flexDirection="column"><Text dimColor={true}>tmux session: {process.env.ALTARIS_TMUX_SESSION}</Text><Text dimColor={true}>{process.env.ALTARIS_TMUX_PREFIX_CONFLICTS ? `Detach: ${process.env.ALTARIS_TMUX_PREFIX} ${process.env.ALTARIS_TMUX_PREFIX} d (press prefix twice - Altaris uses ${process.env.ALTARIS_TMUX_PREFIX})` : `Detach: ${process.env.ALTARIS_TMUX_PREFIX} d`}</Text></Box>;
      $[15] = t11;
      $[16] = t12;
      $[17] = t13;
      $[18] = t14;
  ...
  const borderTitle = ` ${color("text", userTheme)("Altaris")} ${color("inactive", userTheme)(`v${version}`)} `;
  const compactBorderTitle = color("text", userTheme)(" Altaris ");
  ...
  if ($[46] !== welcomeMessage_0) {
    t18 = <Box marginTop={1} flexDirection="column" alignItems="center"><Text bold={true}>ALTARIS</Text><Text dimColor={true}>Argus Teknoloji · Kurumsal Agentic AI Terminal</Text><Text color="inactive">•</Text><Text bold={true}>{welcomeMessage_0}</Text></Box>;
    $[46] = welcomeMessage_0;
    $[47] = t18;
  } else {
    t18 = $[47];
  ...
  if ($[75] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t33 = <EmergencyTip />;
    t34 = process.env.ALTARIS_TMUX_SESSION && <Box paddingLeft={2} flexDirection="column"><Text dimColor={true}>tmux session: {process.env.ALTARIS_TMUX_SESSION}</Text><Text dimColor={true}>{process.env.ALTARIS_TMUX_PREFIX_CONFLICTS ? `Detach: ${process.env.ALTARIS_TMUX_PREFIX} ${process.env.ALTARIS_TMUX_PREFIX} d (press prefix twice - Altaris uses ${process.env.ALTARIS_TMUX_PREFIX})` : `Detach: ${process.env.ALTARIS_TMUX_PREFIX} d`}</Text></Box>;
    $[75] = t29;
    $[76] = t30;
    $[77] = t31;
    $[78] = t32;
