...
export function ChannelsNotice() {
  ...
  if (noAuth) {
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
      t2 = <Text dimColor={true}>Channels require altaris.ai authentication · run /login, then restart</Text>;
      $[9] = t2;
    } else {
      t2 = $[9];
    }
  ...
  let t2;
  if ($[24] !== flag) {
    t2 = <Text dimColor={true}>Experimental · inbound messages will be pushed into this session, this carries prompt injection risks. Restart Altaris without {flag} to disable.</Text>;
    $[24] = flag;
    $[25] = t2;
  } else {
    t2 = $[25];
