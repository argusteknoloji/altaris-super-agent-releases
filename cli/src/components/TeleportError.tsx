    ...
    case "needsLogin":
      {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
          t9 = <Box flexDirection="column"><Text dimColor={true}>Teleport requires a anthropic.com account.</Text><Text dimColor={true}>Your Altaris Pro/Max subscription will be used by Altaris.</Text></Box>;
          $[16] = t9;
        } else {
          t9 = $[16];
        }
        ...
        if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
          t10 = <Dialog title="Log in to Altaris" onCancel={onCancel}>{t9}<Select options={[{
              label: "Login with Altaris account",
              value: "login"
            }, {
              label: "Exit",
              value: "exit"
