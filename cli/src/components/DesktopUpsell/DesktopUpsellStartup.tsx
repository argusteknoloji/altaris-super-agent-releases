...
export function DesktopUpsellStartup(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = {
      label: "Open in Altaris desktop app",
      value: "try" as const
    };
    $[5] = t3;
  } else {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Box marginBottom={1}><Text>Use Altaris in the Altaris desktop app for visual diffs, live app preview, parallel sessions, and more.</Text></Box>;
    $[8] = t6;
  } else {
    t6 = $[8];
  }
  ...
  if ($[11] !== handleSelect || $[12] !== t7) {
    t8 = <PermissionDialog title="Try the Altaris desktop app"><Box flexDirection="column" paddingX={2} paddingY={1}>{t6}<Select options={options} onChange={handleSelect} onCancel={t7} /></Box></PermissionDialog>;
    $[11] = handleSelect;
    $[12] = t7;
    $[13] = t8;
  } else {
