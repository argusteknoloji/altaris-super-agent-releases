...
export function SelectHookMode(t0) {
  ...
  if (hooksForSelectedMatcher.length === 0) {
    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
      t1 = <Box flexDirection="column" gap={1}><Text dimColor={true}>No hooks configured for this event.</Text><Text dimColor={true}>To add hooks, edit settings.json directly or ask Altaris.</Text></Box>;
      $[0] = t1;
    } else {
      t1 = $[0];
    }
