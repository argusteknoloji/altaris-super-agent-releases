 ...
 * confirmation screen and directs users to settings.json or Altaris for edits.
 */
...
export function ViewHookMode(t0) {
  ...
  if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
    t14 = <Text dimColor={true}>To modify or remove this hook, edit settings.json directly or ask Altaris to help.</Text>;
    $[32] = t14;
  } else {
    t14 = $[32];
  }
