 ...
 * or ask Altaris — the menu directs them there.
 *
...
export function HooksConfigMenu(t0) {
  ...
  if (hooksDisabled_1) {
    ...
    if ($[53] !== disabledByPolicy) {
      t32 = !disabledByPolicy && <Text dimColor={true}>To re-enable hooks, remove "disableAllHooks" from settings.json or ask Altaris.</Text>;
      $[53] = disabledByPolicy;
      $[54] = t32;
    } else {
      t32 = $[54];
