...
export function Onboarding({
  ...
  const securityStep = <Box flexDirection="column" gap={1} paddingLeft={1}>
      ...
      <Box flexDirection="column" width={70}>
        ...
        <OrderedList>
          <OrderedList.Item>
            <Text>Altaris can make mistakes</Text>
            <Text dimColor wrap="wrap">
              You should always review Altaris&apos;s responses, especially when
              <Newline />
              running code.
              <Newline />
            </Text>
          ...
          <OrderedList.Item>
            ...
            <Text dimColor wrap="wrap">
              ...
              <Newline />
              <Link url="https://code.altaris.com/docs/en/security" />
            </Text>
          </OrderedList.Item>
        </OrderedList>
      </Box>
  ...
  if (shouldOfferTerminalSetup()) {
    steps.push({
      ...
      component: <Box flexDirection="column" gap={1} paddingLeft={1}>
          <Text bold>Use Altaris&apos;s terminal setup?</Text>
