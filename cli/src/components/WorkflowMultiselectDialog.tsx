...
const WORKFLOWS: WorkflowOption[] = [{
  ...
  label: '@Altaris - Tag @claude in issues and PR comments'
}, {
  value: 'claude-review' as const,
  label: 'Altaris Review - Automated code review on new PRs'
}];
...
export function WorkflowMultiselectDialog(t0) {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box><Text dimColor={true}>More workflow examples (issue triage, CI fixes, etc.) at:{" "}<Link url="https://github.com/anthropics/altaris-action/blob/main/examples/">https://github.com/anthropics/altaris-action/blob/main/examples/</Link></Text></Box>;
    $[4] = t4;
  } else {
    t4 = $[4];
  }
