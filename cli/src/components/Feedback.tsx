...
const GITHUB_ISSUES_REPO_URL = 'https://github.com/argusteknoloji/altaris-super-agent-releases/issues';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Altaris&apos;s functionality (eg. to reduce the risk of bugs
