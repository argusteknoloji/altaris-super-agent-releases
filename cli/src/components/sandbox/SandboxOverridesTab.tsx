...
function OverridesSelect(t0) {
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text dimColor={true}><Text bold={true} dimColor={true}>Allow unsandboxed fallback:</Text>{" "}When a command fails due to sandbox restrictions, Altaris can retry with dangerouslyDisableSandbox to run outside the sandbox (falling back to default permissions).</Text>;
    $[20] = t11;
  } else {
    t11 = $[20];
  }
  ...
  if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
    t13 = <Box flexDirection="column" marginTop={1} gap={1}>{t11}{t12}<Text dimColor={true}>Learn more:{" "}<Link url="https://code.altaris.com/docs/en/sandboxing#configure-sandboxing">code.altaris.com/docs/en/sandboxing#configure-sandboxing</Link></Text></Box>;
    $[22] = t13;
  } else {
    t13 = $[22];
  }
