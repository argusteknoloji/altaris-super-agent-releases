...
import type { ExternalClaudeMdInclude } from '../utils/altarismd.js';
...
export function ClaudeMdExternalIncludesDialog(t0: Props) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Text>This project's ALTARIS.md imports files outside the current working directory. Never allow this for third-party repositories.</Text>;
    $[5] = t6;
  } else {
    t6 = $[5];
  }
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text dimColor={true}>Important: Only use Altaris with files you trust. Accessing untrusted files may pose security risks{" "}<Link url="https://code.altaris.com/docs/en/security" />{" "}</Text>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
  ...
  if ($[12] !== handleEscape || $[13] !== t10 || $[14] !== t4 || $[15] !== t5 || $[16] !== t7) {
    t11 = <Dialog title="Allow external ALTARIS.md file imports?" color="warning" onCancel={handleEscape} hideBorder={t4} hideInputGuide={t5}>{t6}{t7}{t8}{t10}</Dialog>;
    $[12] = handleEscape;
    $[13] = t10;
    $[14] = t4;
    $[15] = t5;
