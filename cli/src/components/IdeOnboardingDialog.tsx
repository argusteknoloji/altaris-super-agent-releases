...
export function IdeOnboardingDialog(t0) {
  ...
  let t6;
  if ($[8] !== ideName) {
    t6 = <>{t5}<Text>Welcome to Altaris for {ideName}</Text></>;
    $[8] = ideName;
    $[9] = t6;
  } else {
    t6 = $[9];
  ...
  if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Text>• Altaris has context of {t8}{" "}and <Text color="suggestion">⧉ selected lines</Text></Text>;
    $[11] = t9;
  } else {
    t9 = $[11];
  }
  ...
  if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text>• Review Altaris's changes{" "}{t10}{" "}<Text color="diffRemovedWord">-22</Text> in the comfort of your IDE</Text>;
    $[13] = t11;
  } else {
    t11 = $[13];
  }
