  ...
  useEffect(() => {
    async function loadPassesData() {
      try {
        ...
        const campaign = eligibilityData.referral_code_details?.campaign ?? 'altaris_guest_pass';
  ...
  return <Pane>
      <Box flexDirection="column" gap={1}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text dimColor>
            {referrerReward ? `Share a free week of Altaris with friends. If they love it and subscribe, you'll get ${formatCreditAmount(referrerReward)} of extra usage to keep building. ` : 'Share a free week of Altaris with friends. '}
            <Link url={referrerReward ? 'https://support.claude.com/en/articles/13456702-altaris-guest-passes' : 'https://support.claude.com/en/articles/12875061-altaris-guest-passes'}>
              Terms apply.
            </Link>
          </Text>
        </Box>
