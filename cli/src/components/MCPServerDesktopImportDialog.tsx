...
export function MCPServerDesktopImportDialog(t0) {
  ...
  const t10 = `Found ${t8} MCP ${t9} in Altaris Desktop.`;
  let t11;
  ...
  if ($[28] !== handleEscCancel || $[29] !== t10 || $[30] !== t11 || $[31] !== t15) {
    t16 = <Dialog title="Import MCP Servers from Altaris Desktop" subtitle={t10} color="success" onCancel={handleEscCancel} hideInputGuide={true}>{t11}{t12}{t15}</Dialog>;
    $[28] = handleEscCancel;
    $[29] = t10;
    $[30] = t11;
    $[31] = t15;
