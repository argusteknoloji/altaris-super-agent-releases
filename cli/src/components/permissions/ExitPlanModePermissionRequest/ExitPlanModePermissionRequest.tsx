  ...
  if (isEmpty) {
    ...
    return <PermissionDialog color="planMode" title="Exit plan mode?" workerBadge={workerBadge}>
        <Box flexDirection="column" paddingX={1} marginTop={1}>
          <Text>Altaris wants to exit plan mode</Text>
          <Box marginTop={1}>
            <Select options={[{
            label: 'Yes',
            value: 'yes' as const
      ...
      <PermissionDialog color="planMode" title="Ready to code?" innerPaddingX={0} workerBadge={workerBadge}>
        <Box flexDirection="column" marginTop={1}>
          <Box paddingX={1} flexDirection="column">
            <Text>Here is Altaris&apos;s plan:</Text>
          </Box>
        ...
        overflow="hidden">
          ...
          <Box flexDirection="column" paddingX={1}>
            ...
            {!useStickyFooter && <>
                <Text dimColor>
                  Altaris has written up a plan and is ready to execute. Would
                  you like to proceed?
                </Text>
                <Box marginTop={1}>
...
export function buildPlanApprovalOptions({
  ...
  if (showUltraplan) {
    options.push({
      label: 'No, refine with Ultraplan on Altaris on the web',
      value: 'ultraplan'
    });
  }
  options.push({
    ...
    value: 'no',
    placeholder: 'Tell Altaris what to change',
