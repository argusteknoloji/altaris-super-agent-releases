...
// event/notch — users on those can set ALTARIS_SCROLL_SPEED=3 to match
...
/** Read ALTARIS_SCROLL_SPEED, default 1, clamp (0, 20].
 ...
 *  set ALTARIS_SCROLL_SPEED=3 to match vim/nvim/opencode. We can't
...
export function readScrollSpeedBase(): number {
  const raw = process.env.ALTARIS_SCROLL_SPEED;
  if (!raw) return 1;
