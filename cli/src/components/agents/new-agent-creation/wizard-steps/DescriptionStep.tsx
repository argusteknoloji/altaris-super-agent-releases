...
export function DescriptionStep() {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text>When should Altaris use this agent?</Text>;
    $[8] = t5;
  } else {
    t5 = $[8];
  }
  ...
  let t8;
  if ($[15] !== t6 || $[16] !== t7) {
    t8 = <WizardDialogLayout subtitle="Description (tell Altaris when to use this agent)" footerText={t4}><Box flexDirection="column">{t5}{t6}{t7}</Box></WizardDialogLayout>;
    $[15] = t6;
    $[16] = t7;
    $[17] = t8;
  } else {
