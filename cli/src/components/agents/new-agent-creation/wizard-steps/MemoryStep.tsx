...
export function MemoryStep() {
  ...
  if ($[1] !== isUserScope) {
    t1 = isUserScope ? [{
      label: "User scope (~/.altaris/agent-memory/) (Recommended)",
      value: "user"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "Project scope (.altaris/agent-memory/)",
      value: "project"
    }, {
      label: "Local scope (.altaris/agent-memory-local/)",
      value: "local"
    }] : [{
      label: "Project scope (.altaris/agent-memory/) (Recommended)",
      value: "project"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "User scope (~/.altaris/agent-memory/)",
      value: "user"
    }, {
      label: "Local scope (.altaris/agent-memory-local/)",
      value: "local"
