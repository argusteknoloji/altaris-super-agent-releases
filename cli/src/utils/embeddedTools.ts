 ...
 *
 * When true:
 * - `find` and `grep` in Altaris's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering Altaris away from find/grep is omitted
 *
...
export function hasEmbeddedSearchTools(): boolean {
  ...
  const e = process.env.ALTARIS_ENTRYPOINT
  return (
