...
/**
 * Detects if a file path is a session-related file under ~/.altaris.
...
/**
 * Check if a file is a Altaris-managed memory file (NOT user-managed instruction files).
 * Includes: auto-memory (memdir), agent memory, session memory/transcripts.
 * Excludes: ALTARIS.md, CLAUDE.local.md, .altaris/rules/*.md (user-managed).
 *
...
// Excludes ALTARIS.md, CLAUDE.local.md, .altaris/rules/ (user-managed).
