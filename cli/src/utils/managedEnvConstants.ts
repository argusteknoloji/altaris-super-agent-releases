 ...
 *
 * When ALTARIS_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
 * are stripped from settings-sourced env so the host's routing config isn't
 * overridden by a user's ~/.altaris/settings.json — e.g. a Bedrock setup for
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'ALTARIS_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  'ALTARIS_USE_BEDROCK',
  'ALTARIS_USE_VERTEX',
  'ALTARIS_USE_FOUNDRY',
  ...
  'ALTARIS_SKIP_BEDROCK_AUTH',
  'ALTARIS_SKIP_VERTEX_AUTH',
  'ALTARIS_SKIP_FOUNDRY_AUTH',
 ...
 * These are Altaris specific settings that don't pose security risks.
 *
...
export const SAFE_ENV_VARS = new Set([
  ...
  'ALTARIS_API_KEY_HELPER_TTL_MS',
  'ALTARIS_DISABLE_EXPERIMENTAL_BETAS',
  'ALTARIS_DISABLE_NONESSENTIAL_TRAFFIC',
  'ALTARIS_DISABLE_TERMINAL_TITLE',
  'ALTARIS_ENABLE_TELEMETRY',
  'ALTARIS_EXPERIMENTAL_AGENT_TEAMS',
  'ALTARIS_IDE_SKIP_AUTO_INSTALL',
