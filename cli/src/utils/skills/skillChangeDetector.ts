...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.altaris/skills)
  ...
  // User commands directory (~/.altaris/commands)
  ...
  // Project skills directory (.altaris/skills)
  ...
  // Project commands directory (.altaris/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.altaris', 'skills')
    try {
