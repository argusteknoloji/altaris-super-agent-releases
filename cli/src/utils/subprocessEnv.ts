...
const GHA_SUBPROCESS_SCRUB = [
  ...
  // altaris-action-specific duplicates — action JS consumes these during
 ...
 * servers, shell hooks).
 *
 * Gated on ALTARIS_SUBPROCESS_ENV_SCRUB. altaris-action sets this
...
export function subprocessEnv(): NodeJS.ProcessEnv {
  ...
  if (!isEnvTruthy(process.env.ALTARIS_SUBPROCESS_ENV_SCRUB)) {
