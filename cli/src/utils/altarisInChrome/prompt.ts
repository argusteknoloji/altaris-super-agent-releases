export const BASE_CHROME_PROMPT = `# Altaris Browser Bridge browser automation
...
/**
 * Minimal hint about Altaris Browser Bridge skill availability. This is injected at startup when the extension is installed
