...
/**
 * Renders a clickable "View Tab" link for Altaris Browser Bridge MCP tools.
 * Returns null if:
 * - The tool is not a Altaris Browser Bridge MCP tool
...
/**
 * Returns tool method overrides for Altaris Browser Bridge MCP tools. Use this to customize
...
export function getClaudeInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `Altaris Browser Bridge[${displayName}]`;
    },
