...
import { queryModelWithoutStreaming } from '../../services/api/altaris.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .altaris/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.altaris', 'skills', skillName, 'SKILL.md')
