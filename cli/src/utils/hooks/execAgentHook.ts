  ...
  try {
    ...
    try {
      ...
      const systemPrompt = asSystemPrompt([
        `You are verifying a stop condition in Altaris. Your task is to verify that the agent completed the given plan. The conversation transcript is available at: ${transcriptPath}\nYou can read this file to analyze the conversation history if needed.
