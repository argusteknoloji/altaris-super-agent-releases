  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.altaris/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .altaris/settings.json'
      } else {
        userGuidance =
      ...
      // from .altaris/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
