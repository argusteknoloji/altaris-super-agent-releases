...
const HOOK_CHAINS_CONFIG_ENV_PATH = 'ALTARIS_HOOK_CHAINS_CONFIG_PATH'
const HOOK_CHAINS_ENABLED_ENV = 'ALTARIS_ENABLE_HOOK_CHAINS'
const DEFAULT_HOOK_CHAINS_RELATIVE_PATH = join('.altaris', 'hook-chains.json')
