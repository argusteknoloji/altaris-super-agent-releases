 ...
 *
 * When ALTARIS_PLUGIN_USE_ZIP_CACHE is enabled, plugins are stored as
...
export async function installPluginsForHeadless(): Promise<boolean> {
  ...
  // Register seed marketplaces (ALTARIS_PLUGIN_SEED_DIR) before diffing.
  ...
  // which composes correctly with ALTARIS_PLUGIN_SEED_DIR: seed registers
