 ...
 *
 * This module is responsible for discovering, loading, and validating Altaris plugins
 ...
 * Format: ~/.altaris/plugins/cache/{marketplace}/{plugin}/{version}/
 *
 * @param pluginId - Plugin identifier in format "name@marketplace"
 * @param version - Version string (semver, git SHA, etc.)
 ...
 * Format: ~/.altaris/plugins/cache/{plugin-name}/
 *
...
async function installFromGitHub(
  ...
  const gitUrl = isEnvTruthy(process.env.ALTARIS_REMOTE)
 ...
 * ALTARIS_REMOTE) or any URL that passes validateGitUrl (https, http,
 * file, git@ ssh).
 */
 ...
 *
 * ALTARIS_SYNC_PLUGIN_INSTALL=1 delegates to the full loader — that
