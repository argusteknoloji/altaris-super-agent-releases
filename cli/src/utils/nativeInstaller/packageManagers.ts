/**
 * Package manager detection for Altaris CLI
 */
...
/**
 * Detects if the currently running Altaris instance was installed via mise
...
/**
 * Detects if the currently running Altaris instance was installed via asdf
...
/**
 * Detects if the currently running Altaris instance was installed via Homebrew
 ...
 * - Homebrew cask: /opt/homebrew/Caskroom/altaris/...
...
/**
 * Detects if the currently running Altaris instance was installed via winget
...
/**
 * Detects if the currently running Altaris instance was installed via pacman
...
/**
 * Detects if the currently running Altaris instance was installed via a .deb package
...
/**
 * Detects if the currently running Altaris instance was installed via an RPM package
...
/**
 * Detects if the currently running Altaris instance was installed via Alpine APK
...
/**
 * Memoized function to detect which package manager installed Altaris
