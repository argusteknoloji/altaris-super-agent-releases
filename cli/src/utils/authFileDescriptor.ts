 ...
 * /home/claude/.altaris/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/claude/.altaris/remote'
 ...
 * rationale. Env var: ALTARIS_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/claude/.altaris/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'ALTARIS_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: ALTARIS_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/claude/.altaris/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'ALTARIS_API_KEY_FILE_DESCRIPTOR',
