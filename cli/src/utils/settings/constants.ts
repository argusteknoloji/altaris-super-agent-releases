...
/**
 * The JSON Schema URL for Altaris settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/altaris-settings.json
 */
export const ALTARIS_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/altaris-settings.json'
