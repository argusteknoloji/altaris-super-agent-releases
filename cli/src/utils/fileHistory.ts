...
export function fileHistoryEnabled(): boolean {
  ...
  return (
    ...
    !isEnvTruthy(process.env.ALTARIS_DISABLE_FILE_CHECKPOINTING)
  )
}

function fileHistoryEnabledSdk(): boolean {
  return (
    isEnvTruthy(process.env.ALTARIS_ENABLE_SDK_FILE_CHECKPOINTING) &&
    !isEnvTruthy(process.env.ALTARIS_DISABLE_FILE_CHECKPOINTING)
  )
}
...
export async function fileHistoryMakeSnapshot(
  ...
  // for any wrapper that honors same-ref returns (src/ALTARIS.md wrapper
