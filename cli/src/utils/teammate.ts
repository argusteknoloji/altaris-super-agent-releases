 ...
 *
 * These helpers identify whether this Altaris instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.ALTARIS_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our ALTARIS_AGENT_ID matches the leadAgentId, OR
 *    - We have no ALTARIS_AGENT_ID set (backwards compat: the original
