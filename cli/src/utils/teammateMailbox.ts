 ...
 *
 * Each teammate has an inbox file at .altaris/teams/{team_name}/inboxes/{agent_name}.json
 ...
 * Structure: ~/.altaris/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to ALTARIS_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's ALTARIS_AGENT_ID */
  workerId: string
  /** Worker's ALTARIS_AGENT_NAME */
  workerName: string
  /** Worker's ALTARIS_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to ALTARIS_TEAM_NAME env var)
