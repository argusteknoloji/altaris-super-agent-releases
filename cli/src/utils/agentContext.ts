 ...
 * variables instead: ALTARIS_AGENT_ID, ALTARIS_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from ALTARIS_PARENT_SESSION_ID env var), undefined for main REPL subagents */
