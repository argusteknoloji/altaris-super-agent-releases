...
/**
 * Captured at module load time to detect if the user started Altaris from within tmux.
 ...
 * because Shell.ts overrides TMUX when Altaris's socket is initialized.
 *
...
export async function isInsideTmux(): Promise<boolean> {
  ...
  // This tells us if the user started Altaris from within their tmux session
