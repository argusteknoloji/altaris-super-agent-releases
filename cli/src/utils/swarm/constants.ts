 ...
 * Includes PID to ensure multiple Altaris instances don't conflict.
 */
 ...
 * If not set, defaults to process.execPath (the current Altaris binary).
 * This allows customization for different environments or testing.
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'ALTARIS_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'ALTARIS_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'ALTARIS_PLAN_MODE_REQUIRED'
