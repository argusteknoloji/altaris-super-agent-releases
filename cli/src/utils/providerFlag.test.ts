...
describe('applyProviderFlag - openai', () => {
  test('sets ALTARIS_USE_OPENAI=1', () => {
    const result = applyProviderFlag('openai', [])
    expect(result.error).toBeUndefined()
    expect(process.env.ALTARIS_USE_OPENAI).toBe('1')
  })
...
describe('applyProviderFlag - gemini', () => {
  test('sets ALTARIS_USE_GEMINI=1', () => {
...
describe('applyProviderFlag - github', () => {
  test('sets ALTARIS_USE_GITHUB=1', () => {
...
describe('applyProviderFlag - bedrock', () => {
  test('sets ALTARIS_USE_BEDROCK=1', () => {
    const result = applyProviderFlag('bedrock', [])
    expect(result.error).toBeUndefined()
    expect(process.env.ALTARIS_USE_BEDROCK).toBe('1')
  })
})

describe('applyProviderFlag - vertex', () => {
  test('sets ALTARIS_USE_VERTEX=1', () => {
    const result = applyProviderFlag('vertex', [])
    expect(result.error).toBeUndefined()
    expect(process.env.ALTARIS_USE_VERTEX).toBe('1')
  })
})

describe('applyProviderFlag - ollama', () => {
  test('sets ALTARIS_USE_OPENAI=1 with Ollama defaults when unset', () => {
...
describe('applyProviderFlag - xai', () => {
  test('sets ALTARIS_USE_OPENAI=1 with xAI defaults when unset', () => {
    delete process.env.OPENAI_BASE_URL
    delete process.env.OPENAI_API_KEY
