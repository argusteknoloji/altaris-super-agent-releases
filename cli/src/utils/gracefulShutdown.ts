...
function cleanupTerminalModes(skipUnmount: boolean = false): void {
  ...
  try {
    ...
    // Respect ALTARIS_DISABLE_TERMINAL_TITLE — if the user opted out of
...
export async function gracefulShutdown(
  ...
  // overall execution via a single budget (ALTARIS_SESSIONEND_HOOKS_TIMEOUT_MS,
