...
If .altaris/loop.md exists, read it and follow it.
Otherwise, if ~/.altaris/loop.md exists, read it and follow it.
Otherwise:
...
1. If .altaris/loop.md exists, read it and use it.
2. Otherwise, if ~/.altaris/loop.md exists, read it and use it.
