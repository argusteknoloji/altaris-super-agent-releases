...
export type ToolUseContext = {
  ...
  /**
   * ALTARIS.md paths already injected as nested_memory attachments this
   ...
   * re-inject the same ALTARIS.md dozens of times.
   */
...
> = {
   ...
   * When exceeded, the result is saved to a file and Altaris receives a preview
