...
/** Altaris decides when and how much to think (Opus 4.6+). */
...
/** Source for loading filesystem-based settings. 'user' - Global user settings (~/.altaris/settings.json). 'project' - Project settings (.altaris/settings.json). 'local' - Local settings (.altaris/settings.local.json). */
...
/** Rate limit information for altaris.ai subscription users. */
