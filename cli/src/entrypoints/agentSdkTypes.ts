/**
 * Main entrypoint for Altaris Agent SDK types.
 *
 ...
 *
 * If your SDK MCP calls will run longer than 60s, override ALTARIS_STREAM_CLOSE_TIMEOUT
 */
...
/**
 * A scheduled task from `<dir>/.altaris/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.altaris/scheduled_tasks.json` and yield events as tasks fire.
 *
