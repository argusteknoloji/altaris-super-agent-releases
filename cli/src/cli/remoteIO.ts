...
export class RemoteIO extends StructuredIO {
  ...
  constructor(
    ...
    const erVersion = process.env.ALTARIS_ENVIRONMENT_RUNNER_VERSION
    if (erVersion) {
    ...
    const refreshHeaders = (): Record<string, string> => {
      ...
      const freshErVersion = process.env.ALTARIS_ENVIRONMENT_RUNNER_VERSION
      if (freshErVersion) {
    ...
    this.isBridge = process.env.ALTARIS_ENVIRONMENT_KIND === 'bridge'
