    ...
    root.render(<AppStateProvider onChangeAppState={onChangeAppState}>
        <KeybindingSetup>
          <Box flexDirection="column" gap={1}>
            ...
            void resolve();
          }} mode="setup-token" startingMessage="This will guide you through long-lived (1-year) auth token setup for your Altaris account. Altaris subscription required." />
          </Box>
        </KeybindingSetup>
      </AppStateProvider>);
  });
