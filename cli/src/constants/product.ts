export const PRODUCT_URL = 'https://altaris.com/altaris'

// Altaris Remote session URLs
export const CLAUDE_AI_BASE_URL = 'https://altaris.ai'
...
/**
 * Get the base URL for Altaris AI based on environment.
 */
 ...
 * endpoints (/v1/code/sessions/{id}/worker/*) want `cse_*` but the altaris.ai
