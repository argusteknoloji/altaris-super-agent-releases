 ...
 *
 * This instruction provides guidance for Altaris's behavior when handling
 ...
 *   - How Altaris handles penetration testing and CTF requests
 *   - What security tools and techniques Altaris will assist with
 ...
 *
 * Altaris: Do not edit this file unless explicitly asked to do so by the user.
 */
