...
/**
 * Loads markdown files from .altaris/output-styles directories throughout the project
 * and from ~/.altaris/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .altaris/output-styles/*.md -> project styles
 * - User ~/.altaris/output-styles/*.md -> user styles (overridden by project styles)
 *
