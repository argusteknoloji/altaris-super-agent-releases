 ...
 *
 * Inbound messages from altaris.ai are injected into the REPL via queuedCommands.
 */
    ...
    if (feature('BRIDGE_MODE')) {
      ...
      void (async () => {
        try {
          ...
          // Assistant mode: perpetual bridge session — altaris.ai shows one
          ...
          // When a user message arrives from altaris.ai, inject it into the REPL.
          ...
          const handle_0 = await initReplBridge({
            ...
            onSetPermissionMode(mode) {
              ...
              //     unchanged (3-way invariant violation per src/ALTARIS.md)
          ...
          if (outboundOnly) {
            ...
            if (cancelled) return;
            setMessages(prev_18 => [...prev_18, createBridgeStatusMessage(url, upgradeNudge ? 'Please upgrade to the latest version of the Altaris mobile app to see your Remote Control sessions.' : undefined)]);
