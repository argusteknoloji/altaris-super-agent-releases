...
/**
 * Surfaces plugin-install prompts driven by `<altaris-hint />` tags
 * that CLIs/SDKs emit to stderr. See docs/altaris-hints.md.
 *
...
import { clearPendingHint, getPendingHintSnapshot, markShownThisSession, subscribeToPendingHint } from '../utils/altarisHints.js';
