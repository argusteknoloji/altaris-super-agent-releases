...
import { CLAUDE_IN_CHROME_MCP_SERVER_NAME, isTrackedClaudeInChromeTabId } from '../utils/altarisInChrome/common.js';
...
/**
 * A hook that listens for prompt notifications from the Altaris for Chrome extension,
