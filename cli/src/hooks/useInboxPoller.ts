 ...
 * - Process-based teammates use their ALTARIS_AGENT_NAME
...
export function useInboxPoller({
  ...
  const poll = useCallback(async () => {
    ...
    // Format messages with XML wrapper for Altaris (include color if available)
    // Transform plan approval requests to include instructions for Altaris
